...
if(isset($files))
{
	...
	foreach ($files as $file) 
	{
		...
		if(strpos($filename, "thumbnail") !== false)
		{
				...
				echo '<script>setTimeout(function(){$("main").append("<button class=\"button items_button\" onclick=\"\"><div class=\"file \"><img class=\"file_img\" src=\"'.$file.'\"></img><p class=\"file_p\">'.$filename.'</p></div></button>");}, '.$delay .');</script>';
		}
		$delay = $delay + 30;
	}
}
